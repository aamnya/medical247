...
<div class="login-container">
    ...
    $conn = new mysqli($servername , $username , $password , $database );
        ...
        {
            throw new Exception( $conn->connect_error ."<br>") ;
        }

        echo "<br> CONNECTED SUCCESSFULY <br>";
        $sql = "INSERT INTO userdata (sr  , username , pass   ) 
                VALUES             (''   , '$uname' , '$pass');
                ";
    ...
    <div class="login-footer">
        <p> <a href="medical247.free.nf">Login</a></p>
    </div>
</div>
